 ...
 */
class Restaurant extends \Menu\Entity\Restaurant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'restaurantId', 'name', 'address', 'phoneNumber');
        }
    ...
    public function getRestaurantId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getRestaurantId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRestaurantId', array());
